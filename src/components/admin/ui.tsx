...
export function Panel({
  ...
  return (
    <section className="overflow-hidden rounded-[var(--radius-card)] border border-[var(--line)] bg-white shadow-[var(--shadow-soft)]">
      {(title || action) && (
...
export function StatCard({
  ...
  const className =
    "block rounded-[var(--radius-card)] border border-[var(--line)] bg-white p-5 shadow-[var(--shadow-soft)]";

  return href ? (
    <Link href={href} className={`${className} card-interactive`}>
      {body}
    </Link>
  ) : (
...
export function Notice({
  ...
  return (
    <div className={`mb-6 rounded-[var(--radius-card)] border px-4 py-3 ${tones[tone]}`}>
  ...
  return (
    <form action={action} className="flex w-full max-w-sm gap-2">
      ...
      <input
        ...
        className="w-full rounded-[var(--radius-control)] border border-[var(--line)] bg-white px-3 py-2 text-sm outline-none focus:border-[var(--brand)]"
      />
      <button
        type="submit"
        className="rounded-[var(--radius-control)] border border-[var(--line)] px-3 py-2 text-sm font-medium text-[var(--ink)] transition hover:border-[var(--brand)] hover:text-[var(--brand)]"
      >
        Tìm
      </button>
    </form>
...
export function Pagination({
  ...
  const link =
    "rounded-[var(--radius-control)] border border-[var(--line)] px-3 py-1.5 text-sm transition hover:border-[var(--brand)] hover:text-[var(--brand)]";
